...
export const en: Record<string, string> = {
  ...
  '업데이트 확인 실패 — 네트워크를 확인하세요': 'Update check failed — check your connection',
  '최신 버전입니다 ({v})': "You're on the latest version ({v})",
  '새 버전 {v}': 'Version {v} available',
  '릴리스 페이지 열기': 'Open the release page',
  '시작할 때 확인함 ✓': 'Check at Launch ✓',
  '시작할 때 확인': 'Check at Launch',
  '복사됨 ✓': 'Copied ✓',
  ...
  '스파클 3개': 'Sparkle trio',
  따옴표: 'Quote',
  '손그림 밑줄': 'Hand-drawn underline',
  '손그림 동그라미': 'Hand-drawn circle',
  '손그림 화살표': 'Hand-drawn arrow',
  '손그림 체크': 'Hand-drawn check',
  하트: 'Heart',
  꽃: 'Flower',
  잎: 'Leaf',
  발자국: 'Paw',
