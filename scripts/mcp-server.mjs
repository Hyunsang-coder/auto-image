...
import { callBridge } from './lib/bridgeClient.mjs'
...
// ---------------------------------------------------------------------------
// Live editing — drive the project open in the desktop app instead of a file on
// disk. Same op vocabulary as patch_bundle, but the user watches it happen and
// keeps whatever slide they were on. Requires the macOS app to be running.
// ---------------------------------------------------------------------------
