...
import { ok, fail, registerKnowledgeTools, registerLiveTools } from '../packages/mcp/lib/tools.mjs'
import { pngForViewing, tmp } from '../packages/mcp/lib/png.mjs'
...
registerKnowledgeTools(server, {
  readImportSpec: () => readFile(join(ROOT, 'docs', 'project-import.md'), 'utf8'),
