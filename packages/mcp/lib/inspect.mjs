// Shape a project into the compact, agent-facing summary used by both
// `project:inspect` (a .studio.zip on disk) and the MCP `live_inspect` tool
// (the project currently open in the desktop app). One vocabulary either way.
//
// `bundle.images` maps imageKey -> a locator string; callers that hold real
// files pass the path inside the zip, the live bridge passes an `idb:` pointer.
